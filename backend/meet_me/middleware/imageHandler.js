  ...
  try{
      upload(req, res, async (err) => {
          ...
          if (fileType === "profile") {
            ...
            // uploads/chatId/20240813-0-fsdjkfhjskdhfjksdfj.jpg
            // uploads/chatId/20240813-1-fsdjkfhjskdhfjksdfj.jpg
            // uploads/chatId/20240813-2-fsdjkfhjskdhfjksdfj.jpg
            // uploads/chatId/20240813-3-gfdjglfdjgkdlfkgjfkdlg.jpg
            dest = path.join(dest, "chats", chatId);
            id = chatId;
          } else {
            // 추후 에러처리
